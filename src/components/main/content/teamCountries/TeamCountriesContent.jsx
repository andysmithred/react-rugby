...
import TeamCountriesIndexView from "./views/TeamCountriesIndexView";
...
const TeamCountriesContent = () => {
  const fetching = useSelector((state) => state.teamCountries.fetchingItems);
  const view = useSelector((state) => state.teamCountries.view);
  ...
  return (
    <div className="content-main">
      <div className="d-flex flex-column content-main">
        {view === "index" && <TeamCountriesIndexView />}
...
export default TeamCountriesContent;
