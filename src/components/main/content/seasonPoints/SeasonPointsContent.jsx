...
import SeasonPointsIndexView from "./views/SeasonPointsIndexView";
...
const SeasonPointsContent = () => {
  const fetching = useSelector((state) => state.seasonPoints.fetchingItems);
  const view = useSelector((state) => state.seasonPoints.view);
  ...
  return (
    <div className="content-main">
      <div className="d-flex flex-column content-main">
        {view === "index" && <SeasonPointsIndexView />}
...
export default SeasonPointsContent;
